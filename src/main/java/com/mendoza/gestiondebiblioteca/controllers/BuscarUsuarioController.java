...
public class BuscarUsuarioController {
    ...
    void onClickAlumnoBtn(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("alumnoEncontrado-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage();
        stage.setScene(scene);
    ...
    void onClickProfesorBtn(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("profesorEncontrado-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage();
        stage.setScene(scene);
