...
public class ActualizarDatosUsuarioController {
    ...
    void onClickAlumnoBtn(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("alumnoActualizar-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage();
        stage.setScene(scene);
        stage.setTitle("Actualizar Datos del Alumno");
        stage.show();
    }
    ...
    void onClickProfesorBtn(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("profesorActualizar-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage();
        stage.setScene(scene);
        stage.setTitle("Actualizar Datos del Profesor");
        stage.show();
    }
